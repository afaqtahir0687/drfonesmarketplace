    ...
    if (validate_imei($imei) == true){
		...
		if($gsmcall == 'Locked' || $gsmcall == 'Unlocked') {
			...
			if(($imsi_tt - $imsi_nb) == 0) {
				//echo "IMEI:<span style='color:black;'> $imei</span><br>IMEI 2:<span style='color:black;'> $imei2</span><br>Serial:<span style='color:black;'> $sn</span><br>Simlock Status:<span style='color:green;'> $gsmcall</span>";
        echo $gsmcall;
			} else {
        echo "Locked $$";
        echo $labelCar;
				//$status = "<span style='color:red;'> Locked</span>";
				//echo "IMEI:<span style='color:black;'> $imei</span><br>IMEI 2:<span style='color:black;'> $imei2</span><br>Serial:<span style='color:black;'> $sn</span><br>Locked Carrier:<span style='color:black;'> $labelCar</span><br>Simlock Status:<span style='color:red;'>$status</span><br>";
			}
		} else {
			if($gsmcall == "chimaera"){
        echo "Locked $$";
        echo "Chimaera Device Policy 2365 Blocked by Apple";
				//echo "IMEI:<span style='color:black;'> $imei</span><br>IMEI 2:<span style='color:black;'> $imei2</span><br>Serial:<span style='color:black;'> $sn</span><br>Locked Carrier: Chimaera Device Policy 2365</span><br>Status:<span style='color:red;'> Blocked by Apple</span><br>";
			}else {
...
function IMSI_ARRAY() {
     ...
     return array('2321069' , '2321170' , '0839012' , '3104101' , '3102605' , '2040400' , '2343303' , '2341590' , '2400700' , '2400111' , '2400885' , '2720303' , '2940102' , '4402011' , '2163011' , '2080111' , '3027204' , '3114801' , '2720110' , '2720161' , '2720172' , '3102600' , '4402081' , '2040400' , '3026103' , '3100900' , '3101500' , '3101508' , '2341091' , '4401020' , '3104011' , '2140130' , '2140198' , '2342091' , '3114800' , '3023704' , '3027204' , '3026104' , '3027204' , '7300304' , '2320170', '3102603' , '2720211' , '2720231', '2720231' , '3115803' , '3134500', '3100901' , '310260' , '3160100', '3105601' , '3301100' , '3104104' , '8390130' , '3115801' , '3040336', '2040438' , '2167000' , '3114801' , '310260' , '3102605' , '4540492','4407002', '3022203', '3022204', '3114801', '3115803', '3134500', '2040438');
}
...
if($imsi=='2321069')
  ...
  return '2389 - US Xfinity Mobile Only - All Others Blocked'; 
  else if($imsi=='3022204')
  return 'Telus Canada'; 
  else if($imsi=='4407002')
  return 'Japan Kiddi'; 
  else if($imsi=='4540492')
  return 'Japan Kiddi'; 
  else if($imsi=='3022203')
  return 'Telus Canada'; 
  else if($imsi=='3114801')
  return 'US TracFone/StraightTalk Locked Policy';
  else if($imsi=='3102605')
  return 'US T-Mobile / Sprint (MVNO) Locked Activation Policy';
  else if($imsi=='3104101')
  return '23 - US AT&T Locked Activation Policy';
  else if($imsi=='3104104')
  return 'Japan KDDI Activation Policy';
    else if($imsi=='2040400') 
  return 'Verizon/Xfinity'; 
  else if($imsi=='3040336') 
  return 'US Verizon Activation Locked'; 
  else if($imsi=='3115801') 
  return 'US Celullar Locked Policy'; 
  else if($imsi=='310260')
  return 'US TracFone/Verizon Locked Policy';
  else if($imsi=='3102605')
  return 'US T-Mobile / Sprint (MVNO) Locked Activation Policy';
    else if($imsi=='3114800')
  return 'US Verizon Locked Policy'; 
        else if($imsi=='3100900')
  return 'US Cricket Service Policy'; 
      else if($imsi=='3100901')
  return 'US Cricket Service Policy'; 
      else if($imsi=='3102603')
  return 'MetroPCS Locked Policy'; 
      else if($imsi=='310260')
  return 'US T-Mobile(Sprint/MVNO) Locked Policy';   
    else if($imsi=='8390130')
  return '23 - US AT&T Locked Activation Policy';
  else if($imsi=='3105601')
  return '23 - US AT&T Activation Policy';
else if($imsi=='2321170')
  return 'A1 MOBILKOM AUSTRIA';
else if($imsi=='0839012') 
  return 'SPRINT USA'; 
  else if($imsi=='2341091')
  return 'UK O2 Tesco Activation Policy';
    else if($imsi=='2140130')
  return 'Spain Vodafone';
      else if($imsi=='2140198')
  return 'Spain Vodafone';
  else if($imsi=='3101508') 
  return 'US Cricket Locked Policy'; 
    else if($imsi=='3115803') 
  return 'US Reseller Flex Policy';
      else if($imsi=='3134500') 
  return 'US Spectrum Mobile Locked Policy';
    else if($imsi=='3104011') 
  return 'US GSM Service Policy'; 
  else if($imsi=='3101500') 
  return 'Cricket USA'; 
  else if($imsi=='3026104') 
  return 'Canada Bell/MTS Locked Policy'; 
  else if($imsi=='3102600')
  return '2408 - US Sprint/T-Mobile Locked Policy';
else if($imsi=='2040400')
  return 'Verizon USA'; 
else if($imsi=='2343303')
  return '302 - UK T-Mobile Orange Policy';
else if($imsi=='2341590')
  return '270 - Vodafone UK';
else if($imsi=='2400700')
  return 'TELE2 SWEDEN';
  else if($imsi=='3022204')
  return 'Canada Telus';
    else if($imsi=='2720110')
  return 'Ireland Vodafone 1';
      else if($imsi=='2720161')
  return 'Ireland Vodafone';
        else if($imsi=='2720172')
  return 'Ireland Vodafone';
      else if($imsi=='3102605')
  return 'US T-Mobile / Sprint (MVNO) Locked Activation Policy';
  else if($imsi=='3160100')
  return 'US Sprint MVNO Service Policy';
    else if($imsi=='3112300')
  return 'C-Spire';
  ...
  return 'Canada Rogers Locked Policy';
else if($imsi=='2040400')
  ...
  return 'WEBLINK';
else if($imsi=='3301100') 
  return 'Puerto Rico Claro';
  ...
  return 'Ireland O2';
  else if($imsi=='2720231') 
  return '2300 - Ireland Hutchison/O2 Locked Policy';
    else if($imsi=='2720231') 
  return 'Ireland O2 3';
  ...
  return 'Japan Softbank iPhone Policy';
  else if($imsi=='4401020') 
  return '2186 - Japan NTT DOCOMO Policy';
  ...
  return 'UK Hutchison Locked Policy';
else if($imsi=='2341091') 
  return 'O2';
  ...
  return 'US Verizon Activation Locked Policy';
else if($imsi=='3102600') 
  return 'METROPCS';
else if($imsi=='3114801') 
...
function albert_attack($query) {
    ...
    $xml_response = mycurl($url,$post_data);
